...
class SyliusUpdateSlugType extends eZWorkflowEventType
{
    ...
    public function execute( $process, $event )
    {
        ...
        elseif( isset($parameters['node_id']) && isset( $parameters['selected_node_id'] ) )
        {
        ...
        foreach( $nodeIDs as $nodeID )
        {
            ...
            {
                eZLog::write('Failed updating url of NodeID: ' . $nodeID . ' - class probably does not have syliusproduct datatype');
            }
        }
        return eZWorkflowType::STATUS_ACCEPTED;
    }
